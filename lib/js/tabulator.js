		...
		select: function select(cell, onRendered, success, cancel, editorParams) {
			...
			function showList() {
				if (!listEl.parentNode) {
					...
					var editorPosition = editorParams.position || 'top';
					var cellOffestHeight = 0;
					switch(editorPosition){
						case 'center':
						case 'middle':
							cellOffestHeight = cellEl.offsetHeight/2;
							break;
						case 'bottom':
							cellOffestHeight = cellEl.offsetHeight;
					}
					listEl.style.top = offset.top + cellOffestHeight + "px";
