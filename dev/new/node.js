...
//                 config.columns=[{"title":"requestId", "field":"requestId", "editor":true}];
config.columns = config.info;
config.columns.replace(/'/g, "");
console.log('\n\nconfig.info\n',config.info,'\n\n\n');
var myColumns = config.info;
delete config.info;
